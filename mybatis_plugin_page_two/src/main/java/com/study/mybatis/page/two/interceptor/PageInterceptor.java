package com.study.mybatis.page.two.interceptor;
...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
       ...
       int total = this.getTotal(invocation, mappedStatement, boundSql);
  ...
  //      BoundSql boundSql = (BoundSql) metaObject.getValue("delegate.boundSql");
    ...
    int getTotal( Invocation invocation, MappedStatement statement, BoundSql boundSql) throws SQLException {
        String sql = boundSql.getSql();
        String countSql = "SELECT COUNT(*)FROM  USER AS total";
